...
const AboutUs = () => {
  ...
  useEffect(() => {
    // shapes del morphin para al imagen en desktop
    const shapes = [
    ...
    // al scrollear se activa e lefect ode la imagen
    if (window.innerWidth <= 999 && imageRef.current) {
      gsap.fromTo(
        imageRef.current,
        { "--_i": 0, filter: "grayscale(100%)" },
        {
          "--_i": 10,
          filter: "grayscale(0%)",
          duration: 1,
    ...
    <div className="about-us-wrapper">
      <div className="about-us-container">
        ...
        <div className="about-us-image-wrapper">
          ...
          {/* mobile */}
          <img
            className="about-us-image-mobile hover-effect"
